...
class EvidenceService {
  ...
  Future<Map<String, dynamic>> uploadEncrypted(Uint8List plainBytes, String name, String mimeType) async {
  ...
  Future<SecretKey> _getOrCreateKey() async {
    ...
    await _storage.write(key: _vaultKey, value: base64UrlEncode(bytes));
