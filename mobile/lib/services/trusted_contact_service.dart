...
class TrustedContactService {
  TrustedContactService({Dio? client, FlutterSecureStorage? storage})
  ...
  Future<void> create({required String name, required String phone, String? relationship}) async {
    await _client.post('/trusted-contacts', data: {
  ...
  Future<void> remove(String id) async {
    await _client.delete('/trusted-contacts/$id', options: await _options());
  }
